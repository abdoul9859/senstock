...
export default function TestimonialsSection() {
  const { ref, revealed } = useStaggerReveal<HTMLDivElement>(0.1);
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
          {testimonials.map((t, i) => (
            <div
              key={t.name}
              className={`group relative flex flex-col rounded-2xl border border-border/60 bg-card p-7 transition-all duration-500 hover:-translate-y-1 hover:border-primary/20 hover:shadow-lg hover:shadow-primary/5 ${
