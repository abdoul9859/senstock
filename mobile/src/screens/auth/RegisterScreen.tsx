...
export default function RegisterScreen() {
  ...
  async function handleRegister() {
    ...
    if (password.length < 6) {
      showAlert("Mot de passe trop court", "Le mot de passe doit contenir au moins 6 caracteres.");
      return;
    }
    setLoading(true);
    ...
    setLoading(false);
    if (!result.success) {
      showAlert("Erreur", result.error || "Inscription echouee");
    }
  }
        ...
        <View style={styles.form}>
          ...
          >
            {loading ? (
              ...
              <Text style={[styles.buttonText, { color: colors.primaryForeground }]}>Creer mon compte</Text>
            )}
          </TouchableOpacity>
        </View>
